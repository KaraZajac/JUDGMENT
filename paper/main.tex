...
--- non-obviously --- binary case accuracy improves as well on the same
post-2010 evaluation window (69.0\% $\to$ 69.6\%; Brier $0.227 \to 0.211$):
it is strictly better, not a sharpness trade (Figure~\ref{fig:splits}).
...
($n = 67{,}047$ reverse-labeled votes; 69{,}825 direction-labeled).
Independence-aggregated case-level accuracy of the deployed cert
configuration is 69.4\% ($n = 7{,}645$ cases); the coalition layer of
\S\ref{sec:coalition} improves case accuracy further on its post-2010
evaluation (69.0\% $\to$ 69.6\%). Every model row is trained, predicted, and
